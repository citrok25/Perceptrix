...
public class BadRequestFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("BadRequestFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("BadRequestFilter:DoAfterProcessing");
        }
	...
	/*
         ...
         * respOut.println("<p><strong>This has been appended by an intrusive
         * filter.</strong></p>");
         *
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        System.out.println("filter is redirecting ");
        wrappedResponse.sendRedirect("error.do");
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("BadRequestFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("BadRequestFilter()");
        }
        StringBuffer sb = new StringBuffer("BadRequestFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("BadRequestFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("BadRequestFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("BadRequestFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("BadRequestFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("BadRequestFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
